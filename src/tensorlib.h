...
DECLARE_FUNC_S_T(operator-, int32_t);
DECLARE_FUNC_T_T(operator-, int32_t);
DECLARE_FUNC_T_S(Plus, int32_t);
DECLARE_FUNC_S_T(Plus, int32_t);
DECLARE_FUNC_T_T(Plus, int32_t);
DECLARE_FUNC_T_S(Minus, int32_t);
DECLARE_FUNC_S_T(Minus, int32_t);
DECLARE_FUNC_T_T(Minus, int32_t);
DECLARE_FUNC_T_S(operator*, int32_t);
DECLARE_FUNC_S_T(operator*, int32_t);
...
DECLARE_FUNC_T_S(operator-, float);
DECLARE_FUNC_S_T(operator-, float);
DECLARE_FUNC_T_S(Plus, float);
DECLARE_FUNC_S_T(Plus, float);
DECLARE_FUNC_T_T(Plus, float);
DECLARE_FUNC_T_S(Minus, float);
DECLARE_FUNC_S_T(Minus, float);
DECLARE_FUNC_T_T(Minus, float);
DECLARE_FUNC_T_T(operator-, float);
DECLARE_FUNC_T_S(operator*, float);
DECLARE_FUNC_S_T(operator*, float);
