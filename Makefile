...
$(TARGET): main.o tensorlib.o device.o layer.o conv2dlayer.o convtranspose2dlayer.o \
	mnistloader.o goku.o conv2dgoku.o convtranspose2dgoku.o drivers/jyn_spi.co drivers/jyn_gpio.o drivers/jyn_flash.o
	 ${CPP} $(LDFLAGS) $^ -o $@ 
