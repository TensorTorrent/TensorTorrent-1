...
Tensor ConvTranspose2dLayer::Forward(const Tensor& input_image) {
	return ConvTranspose2d(input_image, kernel_, stride_, padding_);
}
...
void ConvTranspose2dLayer::SetWeight(const ftensor::Tensor& kernel) {
